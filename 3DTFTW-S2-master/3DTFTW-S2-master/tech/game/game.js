...
//here we are setting up our characters, these will later interact with eachother

var geometry = new THREE.BoxBufferGeometry( 1, 1, 1 );
var material = new THREE.MeshBasicMaterial( {map: new THREE.TextureLoader( ).load('../images/angry.png'), side: THREE.FrontSide} );var head = new THREE.Mesh( geometry, material );
head.position.x = -1.5;
head.position.y = 4.4;
head.position.z = 9;
...
character3 = character.clone();
character3.position.x = -1;
character3.position.y = 1;
